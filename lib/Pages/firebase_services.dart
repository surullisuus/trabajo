...
Future<List<String>> readData() async {
  ...
  CollectionReference collectionReferenceSitios = FirebaseFirestore.instance.collection('Sitios');

  QuerySnapshot querySitios = await collectionReferenceSitios.orderBy('fecha', descending: true).get();
